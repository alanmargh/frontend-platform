...
function getLocaleExtraDayPeriodRules(locale) {
  const data = _findLocaleData(locale);
  checkFullData(data);
  const rules = data[_LocaleDataIndex.ExtraData][
    2
...
function getLocaleExtraDayPeriods(locale, formStyle, width) {
  const data = _findLocaleData(locale);
  checkFullData(data);
  const dayPeriodsData = [data[_LocaleDataIndex.ExtraData][
    0
    /* ɵExtraLocaleDataIndex.ExtraDayPeriodFormats */
  ], data[_LocaleDataIndex.ExtraData][
    1
...
@angular/common/fesm2022/common.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_common.rN7Gj5SEgy-dev.js.map
